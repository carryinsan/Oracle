/**
 * LexisAI Extraction & Indexing Prompts
 * Path: /js/prompts/analysisPrompts.js
 */
import { GLOBAL_OS_INJECTIONS } from './systemPrompts.js';

export const PASS_04_GLOBAL_EXTRACTION = `
...
export const PASS_05_CONTRADICTION_MAPPING = `
...
export const PASS_06_MEMORY_INDEXING = `
...
export const PASS_09_SECONDARY_EXTRACTION = `
System: You are an epistemological scoring engine.
...
export const PASS_10_TOKEN_CONTROL = `
...
export const PASS_11_FACT_CONSISTENCY = `
...
export const PASS_12_GLOBAL_SYNTHESIS = `
